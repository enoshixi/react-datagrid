...
var Cell = createClass({
    ...
    render: function render() {
        ...
        var content = props.renderCell ? props.renderCell(contentProps, text, props) : DOM.div(contentProps, text);

        var renderProps = assign({}, props);

        delete renderProps.contentPadding;
        delete renderProps.data;
        delete renderProps.defaultStyle;
        delete renderProps.firstClassName;
        delete renderProps.header;
        delete renderProps.lastClassName;
        delete renderProps.renderCell;
        delete renderProps.renderText;
        delete renderProps.rowIndex;
        delete renderProps.textPadding;
